...
$MESS['SOTBIT_MULTIBASKET_SPECIFY_BASKETS'] = 'Specify in the request the code from which it is registered:';
$MESS['SOTBIT_MULTIBASKET_SPECIFY_ORDER_PROPERTY'] = 'The reason for writing the data:';
